...
namespace VRDF.UI.Editor
{
	...
	public static class VRPanelEditor
    {
        ...
        [MenuItem("VRDF/UI/VR Panel", priority = 0)]
        [MenuItem("GameObject/VRDF/UI/VR Panel", priority = 0)]
        static void InstantiateVRPanel(MenuCommand menuCommand)
        {
            // Create a custom game object
            GameObject newPanel = (GameObject)PrefabUtility.InstantiatePrefab(Core.Utils.VRDFPrefabReferencer.GetPrefab("VRPanel"));
