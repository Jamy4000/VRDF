...
namespace VRDF.UI.Editor
{
    ...
    public class VRScrollbarEditor : UnityEditor.UI.ScrollbarEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.LabelField("VRDF Parameters", EditorStyles.boldLabel);
            EditorGUILayout.Space();
        ...
        [MenuItem("VRDF/UI/VR Scrollbar/Vertical", priority = 0)]
        [MenuItem("GameObject/VRDF/UI/VR Scrollbar/Vertical", priority = 0)]
        static void InstantiateVRScrollbarVertical(MenuCommand menuCommand)
        {
            // Create a custom game object
            GameObject newScrollbar = (GameObject)PrefabUtility.InstantiatePrefab(Core.Utils.VRDFPrefabReferencer.GetPrefab("VRScrollbarVertical"));
        ...
        /// </summary>
        /// <param name="menuCommand"></param>
        [MenuItem("VRDF/UI/VR Scrollbar/Horizontal", priority = 0)]
        [MenuItem("GameObject/VRDF/UI/VR Scrollbar/Horizontal", priority = 0)]
        static void InstantiateVRScrollbarHorizontal(MenuCommand menuCommand)
        {
            // Create a custom game object
            GameObject newScrollbar = (GameObject)PrefabUtility.InstantiatePrefab(Core.Utils.VRDFPrefabReferencer.GetPrefab("VRScrollbarHorizontal"));
