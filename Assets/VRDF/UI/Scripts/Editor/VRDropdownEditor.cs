...
namespace VRDF.UI.Editor
{
    ...
    public class VRDropdownEditor : UnityEditor.UI.DropdownEditor
    {
        ...
        [MenuItem("VRDF/UI/VR Dropdown", priority = 0)]
        [MenuItem("GameObject/VRDF/UI/VR Dropdown", priority = 0)]
        static void InstantiateVRDropDown(MenuCommand menuCommand)
        {
            // Create a custom game object
            GameObject newDropdown = (GameObject)PrefabUtility.InstantiatePrefab(Core.Utils.VRDFPrefabReferencer.GetPrefab("VRDropdown"));
