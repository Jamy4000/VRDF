...
namespace VRDF.UI.Editor
{
    ...
    public class VRInputFieldEditor : TMPro.EditorUtilities.TMP_InputFieldEditor
    {
        ...
        [MenuItem("VRDF/UI/Input Field/VR Input Field", priority = 0)]
        [MenuItem("GameObject/VRDF/UI/Input Field/VR Input Field", priority = 0)]
        static void InstantiateVRInputField(MenuCommand menuCommand)
        {
            // Create a custom game object
            GameObject newInputField = (GameObject)PrefabUtility.InstantiatePrefab(Core.Utils.VRDFPrefabReferencer.GetPrefab("VRInputField"));
        ...
        /// </summary>
        [MenuItem("VRDF/UI/Input Field/VR Keyboard", priority = 0)]
        [MenuItem("GameObject/VRDF/UI/Input Field/VR Keyboard Example", priority = 0)]
        static void InstantiateVRKeyboard(MenuCommand _)
        {
            // Create a custom game object
            GameObject newKeyboard = (GameObject)PrefabUtility.InstantiatePrefab(Core.Utils.VRDFPrefabReferencer.GetPrefab("VRKeyboard"));
