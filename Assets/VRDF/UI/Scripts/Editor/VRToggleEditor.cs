...
namespace VRDF.UI.Editor
{
    ...
    public class VRToggleEditor : UnityEditor.UI.ToggleEditor
	{
        ...
        [MenuItem("VRDF/UI/VR Toggle", priority = 0)]
        [MenuItem("GameObject/VRDF/UI/VR Toggle", priority = 0)]
        static void InstantiateVRToggle(MenuCommand menuCommand)
        {
            // Create a custom game object
            GameObject newToggle = (GameObject)PrefabUtility.InstantiatePrefab(Core.Utils.VRDFPrefabReferencer.GetPrefab("VRToggle"));
