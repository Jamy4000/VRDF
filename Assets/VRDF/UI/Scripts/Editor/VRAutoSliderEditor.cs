...
namespace VRDF.UI.Editor
{
    ...
    public class VRAutoFillSliderEditor : UnityEditor.UI.SliderEditor
    {
        ...
        [MenuItem("VRDF/UI/Sliders/VR AutoFill Slider", priority = 0)]
        [MenuItem("GameObject/VRDF/UI/Sliders/VR AutoFill Slider", priority = 0)]
        static void InstantiateVRAutoFillSlider(MenuCommand menuCommand)
        {
            // Create a custom game object
            GameObject newSlider = (GameObject)PrefabUtility.InstantiatePrefab(VRDFPrefabReferencer.GetPrefab("VRAutoFillSlider"));
