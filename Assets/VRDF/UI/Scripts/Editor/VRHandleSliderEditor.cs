...
namespace VRDF.UI.Editor
{
    ...
    public class VRHandleSliderEditor : UnityEditor.UI.SliderEditor
    {
        ...
        [MenuItem("VRDF/UI/Sliders/VR Handle Slider", priority = 0)]
        [MenuItem("GameObject/VRDF/UI/Sliders/VR Handle Slider", priority = 0)]
        static void InstantiateVRHandleSlider(MenuCommand menuCommand)
        {
            // Create a custom game object
            GameObject newSlider = (GameObject)PrefabUtility.InstantiatePrefab(Core.Utils.VRDFPrefabReferencer.GetPrefab("VRHandleSlider"));
