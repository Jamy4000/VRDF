...
namespace VRDF.UI.Editor
{
    ...
    public class VRScrollRectEditor : UnityEditor.UI.ScrollRectEditor
    {
        ...
        [MenuItem("VRDF/UI/VR ScrollView", priority = 0)]
        [MenuItem("GameObject/VRDF/UI/VR ScrollView", priority = 0)]
        static void InstantiateVRScrollRect(MenuCommand menuCommand)
        {
            // Create a custom game object
            GameObject newScrollRect = (GameObject)PrefabUtility.InstantiatePrefab(Core.Utils.VRDFPrefabReferencer.GetPrefab("VRScrollView"));
