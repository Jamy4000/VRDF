...
namespace VRDF.MoveAround.Fly
{
    ...
    public class FlyBoundariesEditor : Editor
    {
        ...
        [MenuItem("GameObject/VRDF/Move Around/Fly Mode/Without Boundaries", priority = 3)]
        [MenuItem("VRDF/Move Around/Fly Mode/Without Boundaries", priority = 3)]
        ...
        /// </summary>
        /// <param name="menuCommand"></param>
        [MenuItem("GameObject/VRDF/Move Around/Fly Mode/With Boundaries", priority = 3)]
        [MenuItem("VRDF/Move Around/Fly Mode/With Boundaries", priority = 3)]
