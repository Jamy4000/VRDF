    ...
    public static class TeleporterSetupHelper
    {
        ...
        public static void SetupTeleportStuffs(ref EntityManager entityManager, ref Entity entity, GeneralTeleportAuthoring generalTeleportParam)
        {
            ...
            if (generalTeleportParam.IsUsingFadingEffect && !hasFadingCanvas)
                Debug.LogError("<b>[VRDF] :</b> You requested to use a fading effect for the teleport feature on GameObject " + generalTeleportParam.gameObject.name + ", but no CameraFadeAuthoring is placed under your Camera." +
                    "Try to do in your hierarchy RightClick > VRDF > Utils > Add Camera Fade.");
