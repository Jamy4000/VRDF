...
namespace VRDF.Core
{
    ...
    public class ScriptableSingleton<T> : ScriptableObject where T : ScriptableSingleton<T>
    {
        ...
        /// </summary>
        private static string _VRDFResources
        {
            get
            {
                return "Assets/VRDF/Core/Resources";
            }
        }
        ...
        {
            if (!Directory.Exists(_VRDFResources))
                Directory.CreateDirectory(_VRDFResources);

            string filePath = Path.Combine(_VRDFResources, _fileName + ".asset");
