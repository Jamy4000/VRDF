...
namespace VRDF.Core.SetupVR
{
    ...
    public class SetupVREditor : Editor
    {
        ...
        [MenuItem("GameObject/VRDF/Add SetupVR to Scene", priority = 0)]
        [MenuItem("VRDF/Add SetupVR to Scene", priority = 0)]
        private static void InstantiateSetupVR(MenuCommand menuCommand)
        {
            ...
            {
                Debug.LogError("<b>[VRDF] :</b> SetupVR is already present in the scene.\n" +
            ...
            var setupVRPrefab = Utils.VRDFPrefabReferencer.GetPrefab("SetupVR");
