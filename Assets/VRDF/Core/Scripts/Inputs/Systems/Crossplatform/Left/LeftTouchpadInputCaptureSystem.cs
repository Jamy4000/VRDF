...
namespace VRDF.Core.Inputs
{
    ...
    public class LeftTouchpadInputCaptureSystem : JobComponentSystem
    {
        ...
        private void CheckDevice(OnSetupVRReady info)
        {
            ...
            _isUsingOculusDevice = VRDF_Components.DeviceLoaded == EDevice.OCULUS_GO || VRDF_Components.DeviceLoaded == EDevice.OCULUS_QUEST || VRDF_Components.DeviceLoaded == EDevice.OCULUS_RIFT || VRDF_Components.DeviceLoaded == EDevice.OCULUS_RIFT_S;
        }
