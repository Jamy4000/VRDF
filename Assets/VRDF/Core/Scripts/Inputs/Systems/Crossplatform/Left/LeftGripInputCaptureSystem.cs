...
namespace VRDF.Core.Inputs
{
    ...
    public class LeftGripInputCaptureSystem : JobComponentSystem
    {
        ...
        {
            this.Enabled = VRDF_Components.DeviceLoaded != EDevice.SIMULATOR && VRDF_Components.DeviceLoaded != EDevice.GEAR_VR && VRDF_Components.DeviceLoaded != EDevice.OCULUS_GO;
        }
