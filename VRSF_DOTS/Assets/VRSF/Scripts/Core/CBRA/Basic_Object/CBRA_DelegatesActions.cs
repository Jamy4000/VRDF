...
{
    public class CBRA_DelegatesActions
    {
        //public readonly BACGeneralComponent BACGeneral;
        //public readonly BACCalculationsComponent BACCalculations;

        //public CBRA_DelegatesActions(BACGeneralComponent bacGeneral, BACCalculationsComponent bacCalcul)
        //{
        ...
        public void StartActionDown(ButtonClickEvent eventButton)
        {
            ...
            void ActionDown()
            {
                ...
                //    {
                //        case EHand.RIGHT:
                //            ThumbPositionChecker.CheckThumbPosition(BACGeneral.RightClickThumbPosition, BACGeneral.OnButtonStartClicking, BACGeneral.ClickThreshold, BACCalculations.ThumbPos.Value);
                //            break;
                //        case EHand.LEFT:
                //            ThumbPositionChecker.CheckThumbPosition(BACGeneral.LeftClickThumbPosition, BACGeneral.OnButtonStartClicking, BACGeneral.ClickThreshold, BACCalculations.ThumbPos.Value);
                //            break;
                //    }
                //}
                //else
        ...
        public void StartActionTouched(ButtonTouchEvent eventButton)
        {
            ...
            void ActionTouched()
            {
                ...
                //    {
                //        case EHand.RIGHT:
                //            ThumbPositionChecker.CheckThumbPosition(BACGeneral.RightTouchThumbPosition, BACGeneral.OnButtonStartTouching, BACGeneral.TouchThreshold, BACCalculations.ThumbPos.Value);
                //            break;
                //        case EHand.LEFT:
                //            ThumbPositionChecker.CheckThumbPosition(BACGeneral.LeftTouchThumbPosition, BACGeneral.OnButtonStartTouching, BACGeneral.TouchThreshold, BACCalculations.ThumbPos.Value);
                //            break;
                //    }
                //}
                //else
        ...
        {
            return true;// BACGeneral.ButtonHand == handInteracting && BACGeneral.ActionButton == buttonInteracting && BACCalculations.CanBeUsed;
        }
    }
}