...
namespace VRSF.Core.LaserPointer
{
    public class LaserPointerInstantiater : Editor
    {
        ...
        [MenuItem("GameObject/VRSF/Raycaster, Laser Pointer and VR Clicker/Add Basic Raycaster", priority = 1)]
        [MenuItem("VRSF/Raycaster, Laser Pointer and VR Clicker/Add Basic Raycaster", priority = 1)]
        ...
        /// </summary>
        /// <param name="menuCommand"></param>
        [MenuItem("GameObject/VRSF/Raycaster, Laser Pointer and VR Clicker/Add Raycaster with Laser Pointer", priority = 1)]
        [MenuItem("VRSF/Raycaster, Laser Pointer and VR Clicker/Add Raycaster with Laser Pointer", priority = 1)]
        ...
        /// </summary>
        /// <param name="menuCommand"></param>
        [MenuItem("GameObject/VRSF/Raycaster, Laser Pointer and VR Clicker/Add Raycaster with VR Clicker", priority = 1)]
        [MenuItem("VRSF/Raycaster, Laser Pointer and VR Clicker/Add Raycaster with VR Clicker", priority = 1)]
        ...
        /// </summary>
        /// <param name="menuCommand"></param>
        [MenuItem("GameObject/VRSF/Raycaster, Laser Pointer and VR Clicker/Add Raycaster with Laser and VR Clicker", priority = 1)]
        [MenuItem("VRSF/Raycaster, Laser Pointer and VR Clicker/Add Raycaster with Laser and VR Clicker", priority = 1)]
